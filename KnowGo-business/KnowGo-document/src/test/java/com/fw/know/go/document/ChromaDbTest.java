...
public class ChromaDbTest {
    ...
    void testAddDocument() {
        ...
        // 验证文档是否添加成功
        List<Document> documentResults = vectorDatasourceService.similaritySearch("武汉", 5);
    ...
    void testSimilaritySearch() {
        ...
        // 执行相似性查询
        List<Document> results = vectorDatasourceService.similaritySearch("Spring Boot框架", 5);
