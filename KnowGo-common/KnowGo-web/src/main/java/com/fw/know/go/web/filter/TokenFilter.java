package com.fw.know.go.web.filter;
...
public class TokenFilter implements Filter {
    ...
    private final RedissonClient resdissonClient;

    public TokenFilter(RedissonClient resdissonClient) {
        this.resdissonClient = resdissonClient;
    }
    ...
    private boolean checkTokenValidity(String token, Boolean isStress) {
        ...
        if (isStress){
            ...
            try {
                ...
                result = (String) resdissonClient.getScript().eval(RScript.Mode.READ_WRITE,
                        luaScript,
